...
export const renderBackground = (
  ...
  if (cache) {
    ...
    newCache.backgroundSprite.texture = backGroundTexture;
    newCache.backgroundSprite2.texture = backGroundTexture;
    return cache;
  }

  const backgroundSprite = new PIXI.TilingSprite(backGroundTexture);
  ...
  cardBorderGraphics.drawRoundedRect(22, 22, 486, backGroundTexture.height * 1.5, 16);
